            ...
            {loading ? (
              ...
              <>
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2 flex-wrap text-neutral-500">
                    {selectedSpecialties && selectedSpecialties.length > 0
                      ? selectedSpecialties.map((specialty) => (
                          <Badge
                            key={specialty.id}
                            variant="secondary"
                            className="flex items-center gap-1 bg-neutral-100 text-black"
                          >
                            {specialty.name}
                          </Badge>
                        ))
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {selectedSpecialties.map((specialty) => (
                    <Badge
                      key={specialty.id}
                      variant="secondary"
                      className="relative pr-8 bg-neutral-100"
                    >
                      {specialty.name}
                      <button
                        type="button"
